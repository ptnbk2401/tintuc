...
Route::namespace('Auth')->group(function(){
    ...
    Route::get('auth/callback/{social}', [
        'uses' => 'AuthController@callback',
        'as' => 'auth.auth.callback',
    ]);

    Route::get('auth/redirect/{social}', [
        'uses' => 'AuthController@redirectLogin',
        'as' => 'auth.auth.redirect',
    ]);
});
Route::namespace('Vadmin\Core\Index')->middleware('auth')->middleware('vneauth:superadmin|admin')->group(function () {
    Route::get('/admincp', [
...
Route::namespace('Vadmin')->prefix('vadmin')->middleware('auth')->group(function () {
    ...
    Route::namespace('Core')->prefix('core')->middleware('vneauth:superadmin|admin')->group(function () {
        ...
        Route::namespace('NapThe')->prefix('napthe')->group(function () {
            ...
            ])->middleware('vneauth:superadmin|admin');
            Route::post('/index', [
        ...
        Route::namespace('PopularTags')->prefix('tags')->group(function () {
            Route::get('index',[
                'uses' => 'AcptIndexController@index',
                'as'   => 'vadmin.core.tags.index'
            ]);
            Route::get('edit/{id}',[
                'uses' => 'AcptIndexController@getEdit',
                'as'   => 'vadmin.core.tags.edit'
            ]);
            Route::post('edit/{id}',[
                'uses' => 'AcptIndexController@postEdit',
                'as'   => 'vadmin.core.tags.edit'
            ]);
            Route::get('add',[
                'uses' => 'AcptIndexController@getAdd',
                'as'   => 'vadmin.core.tags.add'
            ]);
            Route::get('del/{id}',[
                'uses' => 'AcptIndexController@del',
                'as'   => 'vadmin.core.tags.del'
            ]);
            Route::post('add',[
                'uses' => 'AcptIndexController@postAdd',
                'as'   => 'vadmin.core.tags.add'
            ]);
        });
...
Route::namespace('Vpublic')->group(function () {
    ...
    Route::namespace('Core')->group(function () {
        ...
        Route::get('/set-rate',[
            'uses' => 'PcBlogController@DanhGiaSao',
            'as'   => 'vpublic.core.pcsingle.star'
        ]);
        Route::get('/gridcat/{cname}/{id}', [
            'uses' => 'PcindexController@gridCat',
            'as'   => 'vpublic.core.pcgridcat.index'
        ]);
        Route::get('/listcat/{cname}/{id}', [
            'uses' => 'PcindexController@listCat',
            'as'   => 'vpublic.core.pclistcat.index'
        ]);
        Route::get('/detail', [
        ...
        Route::get('/shopping-cart', [
            'uses' => 'PcindexController@shoppingcart',
            'as'   => 'vpublic.core.pcshcart.index'
        ]);
        Route::get('/checkout', [
            'uses' => 'PcindexController@checkout',
            'as'   => 'vpublic.core.pccheckout.index'
        ]);
        Route::get('/search', [
            'uses' => 'PcindexController@searchItem',
            'as'   => 'vpublic.core.pcblog.search'
        ]);
        Route::get('/tag', [
            'uses' => 'PcindexController@searchItem',
            'as'   => 'vpublic.core.pcblog.tag'
        ]);
        Route::get('/{codecat}/{codesingle}_{id}.html', [
            'uses' => 'PcBlogController@BlogDetail',
            'as'   => 'vpublic.core.pcbloglist.detail'
        ]);
        Route::get('/{codecat}', [
            'uses' => 'PcBlogController@BlogCat',
            'as'   => 'vpublic.core.pcbloglist.index'
        ]);
        
        Route::post('/blog-comment/{aid}/', [
            'uses' => 'PcBlogController@BlogComment',
            'as'   => 'vpublic.core.pcbloglist.comment'
        ]);
    ...
    Route::prefix('account')->group(function() {
        ...
        Route::get('profile', [
            'uses' => 'PAuthController@profile',
            'as' => 'vpublic.profile.index',
        ]);
        Route::post('edit-profile', [
            'uses' => 'PAuthController@postProfile',
            'as' => 'vpublic.profile.edit',
        ]);
        Route::post('upload', [
            'uses' => 'PAuthController@uploadAvatar',
            'as' => 'vadmin.core.profile.upload',
        ]);
        Route::get('register', [
            'uses' => 'PAuthController@register',
            'as' => 'vpublic.pauth.register',
        ]);
        Route::post('register', [
            'uses' => 'PAuthController@postRegister',
            'as' => 'vpublic.pauth.register',
        ]);
        Route::get('resendemail/{code}', [
            'uses' => 'PAuthController@reSendEmail',
            'as' => 'vpublic.pauth.resendemail',
        ]);
        Route::get('activeuser/{code}', [
            'uses' => 'PAuthController@activeUser',
            'as' => 'vpublic.pauth.activeuser',
        ]);
        Route::get('login-1', [
            'uses' => 'PAuthController@getLogin',
            'as' => 'vpublic.pauth.login',
        ]);
        Route::get('logout', [
            'uses' => 'PAuthController@logout',
            'as' => 'vpublic.pauth.logout',
        ]);
        Route::post('login-1', [
            'uses' => 'PAuthController@postLogin',
            'as' => 'vpublic.pauth.login',
        ]);
        Route::post('forgetpassword', [
            'uses' => 'PAuthController@forgotPassword',
            'as' => 'vpublic.pauth.forgetpassword',
        ]);
        Route::get('resetpassword/{token}', [
            'uses' => 'PAuthController@resetPassword',
            'as' => 'vpublic.pauth.resetpassword',
        ]);
        Route::post('updatepassword', [
            'uses' => 'PAuthController@updatePassword',
            'as' => 'vpublic.pauth.updatepassword',
        ]);
    });
});
