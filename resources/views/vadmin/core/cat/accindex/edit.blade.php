...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Danh mục business <small>Sửa</small></h3>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br>
            <form action="{{ route('vadmin.core.cat.edit', $arItem['cat_id']) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
              {{ csrf_field() }}
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên danh mục</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" name="name" value="{{ old('name', $arItem['cname']) }}"  onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" class="form-control" placeholder="Nhập tên danh mục">
                </div>
              </div>
               <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Mã code</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" name="code" class="form-control" placeholder="Nhập mã code" id="slug-text" value="{{ old('code', $arItem['code']) }}"  readonly>
                    </div>
                </div>
              <div class="form-group">
